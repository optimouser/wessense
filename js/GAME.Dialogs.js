...
GAME.Dialogs.ProceedWithNewGame = function() {
	...
	GAME.progress_control.Add('Generating mask..', 'WORLD_MASK_GENERATION_PROGRESS');
	GAME.progress_control.Add('Generating land..', 'LAND_GENERATION_PROGRESS');
	GAME.progress_control.Add('Generating swamps..', 'SWAMPS_GENERATION_PROGRESS');
	GAME.progress_control.Add('Generating objects..', 'OBJECTS_GENERATION_PROGRESS');
	GAME.progress_control.Add('Generating monsters..', 'MONSTERS_GENERATION_PROGRESS');
